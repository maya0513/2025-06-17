...
namespace UnityEngine.XR.Interaction.Toolkit.Samples.StarterAssets
{
    ...
    public class VRWheelchairOpenXRIntegration : MonoBehaviour
    {
        ...
        private LocomotionProvider m_StandardMovementProvider;
        ...
        void Awake()
        {
            ...
            if (m_StandardMovementProvider == null)
                m_StandardMovementProvider = FindFirstObjectByType<LocomotionProvider>();
        ...
        private void CheckPlayAreaBounds()
        {
            ...
            // プレイエリアの境界を取得（OpenXR/XR管理システムから）
